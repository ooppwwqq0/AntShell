...
class BaseToolsBox(object):
    ...
    def colorMsg(m="", c="red", flag=False, title=False, end='\n'):
        ...
        color = colorCode.get(c,"red")
        colorSign = "\033[" + sign + ";"+cplor+"m{0}\033[0m" 
        colorSign = {
            "red": "\033[" + sign + ";31m{0}\033[0m",
            "green": "\033[" + sign + ";32m{0}\033[0m",
            "yellow": "\033[" + sign + ";33m{0}\033[0m",
            "blue": "\033[" + sign + ";34m{0}\033[0m",
            "pink": "\033[" + sign + ";35m{0}\033[0m",
            "cblue": "\033[30;46m{0}\033[0m",
            "white": "\033[" + sign + ";47m{0}\033[0m",
        }
