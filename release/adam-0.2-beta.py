...
class Parser(BaseHandle):
    ...
    def __init__(self):
        ...
        self.description = "usage: %(prog)s [options] x"
    ...
    def Argparser(self):
        ...
        parser.add_argument("-a", "--add", dest="add", action="store", type=str,
                            help="%s" %self.lang["add"], default="", metavar="ip")
        parser.add_argument("-c", "--commod", dest="commod", action="store", type=str,
        ...
        parser.add_argument("-d", "--delete", dest="dels", action="store", type=str,
        ...
        parser.add_argument("-F", "--fs", dest="fs", action="store", type=str,
                            help="%s" %self.lang["fs"], default=",", metavar="','")
        parser.add_argument("-g", "--get", dest="get", action="store", type=str,
                            help="%s" %self.lang["get"], default="", metavar="file_path")
        parser.add_argument("-G", "--group", dest="group", action="store", type=str,
                            help="%s" %self.lang["group"], default="", metavar="g1>g2")
        parser.add_argument("-l", "--lists", dest="lists", action="store_true", default=False,
                            help="%s" %self.lang["lists"])
        parser.add_argument("-m", "--mode", dest="mode", action="store", type=int,
        ...
        parser.add_argument("-p", "--put", dest="put", action="store", type=str,
                            help="%s" %self.lang["put"], default="", metavar="dir_path")
        parser.add_argument("-P", "--para", dest="para", action="store_true", default=False,
                            help="%s" %self.lang["para"])
        parser.add_argument("-s", "--search", dest="search", action="store", type=str,
                            help="%s" %self.lang["search"], default="", metavar="ip|name")
        parser.add_argument("-o", "--old", dest="old", action="store_true", default=False,
